...
const Movies = () => {
    ...
    return(
        <div className="bg-black text-white py-3">
            <p className="text-3xl my-3 font-bold text-center">MOVIES</p>
            <p className="text-3xl my-3 font-bold text-center">PAGE NUMBER <span className="text-[#0DCAF0]">{numberPagination}</span> FROM <span className="text-[#0DCAF0]">500</span></p>
