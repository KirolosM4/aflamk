...
const AllCastAndCrewSeries = () => {
    const dispatch = useDispatch();
    const {seriesId} = useParams();
    const {creditSeries:{cast,crew},loadingCredit,errCredit} = useSelector(reducer=>reducer.seriesDetails)
...
export default AllCastAndCrewSeries;
