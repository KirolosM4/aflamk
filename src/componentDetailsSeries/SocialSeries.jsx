...
const SocialSeries = () => {
    ...
    const {detailsSeries:{title}} = useSelector(reducer=>reducer.seriesDetails)
    const {reviews,loadingReviews,errReviews} = useSelector(reducer=>reducer.ReviewsDataSeries);
