...
const InfoPerson = () => {
    ...
    return(
        ...
        <ErrorGetData/>
        :
        <div className="w-full px-3 text-left text-white flex flex-col gap-5 lg:items-center lg:w-[30%]">
            ...
            <p className="text-center flex flex-col gap-2 text-lg:text-left">Known For <span className="text-[#0DCAF0]">{known_for_department}</span></p>
            <p className="text-center flex flex-col gap-2 text-lg:text-left">Known Credits <span className="text-[#0DCAF0]">{also_known_as?.length}</span></p>
            <p className="text-center flex flex-col gap-2 text-lg:text-left">Gender <span className="text-[#0DCAF0]">{gender == 1 ? "female" : "male"}</span></p>
            <p className="text-center flex flex-col gap-2 text-lg:text-left">Birthday <span className="text-[#0DCAF0]">{birthday}</span></p>
            <p className="text-center flex flex-col gap-2 text-lg:text-left">Place of Birth<span className="text-[#0DCAF0]">{place_of_birth}</span></p>
            <p className="text-center flex flex-col gap-2 text-lg:text-left">Also Known As {also_known_as?.map((also)=>(<span className="text-[#0DCAF0] text-sm">{also}</span>))}</p>
        </div>
    )
}
